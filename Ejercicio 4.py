#Los teléfonos de una empresa tienen el siguiente formato prefijo-número-extensión donde el prefijo es el código del
...
telefono = input("Introduce el numero de telefono con prefijo y la extension (xx- xxxxxxxxx -xx")
